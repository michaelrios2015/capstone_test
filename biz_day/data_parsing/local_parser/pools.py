...
def parse_pools(date):
    ...
    data_path = "biz_day/data/input/monthlySFPS_" + date + ".txt"
    ...
    with open("biz_day/data/output/pools.cvs", "w", newline="") as csvfile:
    ...
    with open("biz_day/data/output/poolbodies.cvs", "w", newline="") as csvfile:
        # creating a csv writer object
        csvwriter = csv.writer(csvfile)
